...
INSERT INTO `orders` VALUES (12,12,NULL,NULL,'pending','dashboard',800.00,NULL,NULL,NULL,'2026-05-30 12:33:16','2026-05-30 12:33:16'),(13,13,NULL,NULL,'shipped','dashboard',550.00,NULL,NULL,NULL,'2026-05-30 23:00:09','2026-06-03 23:28:26'),(14,12,NULL,NULL,'pending','dashboard',1600.00,NULL,NULL,NULL,'2026-06-03 23:45:25','2026-06-03 23:45:25');
...
CREATE TABLE `productreviews` (
  ...
  CONSTRAINT `productreviews_chk_1` CHECK ((`vleresimi` between 1 and 5))
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `productreviews` VALUES (1,17,12,4,'amazing!!','2026-06-04 14:55:12');
...
INSERT INTO `suppliers` VALUES (1,'kosovako','345','ver@ljnvle','3452345','krbevoer',NULL,'2026-05-02 22:56:14');
...
CREATE TABLE `warranties` (
  ...
  `customer_id` int NOT NULL,
  `lloji` varchar(100) DEFAULT 'standard',
...
-- Dump completed on 2026-06-04 14:57:47
