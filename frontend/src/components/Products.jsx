...
function Products() {
  ...
  const handleEdit = (p) => {
    setEditId(p.id);
    setForm({
      emri: p.emri || '', kategoria_id: p.kategoria_id || '', marka: p.marka || '',
      modeli: p.modeli || '', pershkrimi: p.pershkrimi || '', cmimi: p.cmimi || '',
      cmimi_zbritjes: p.cmimi_zbritjes || '', sasia_stokut: p.sasia_stokut || '',
