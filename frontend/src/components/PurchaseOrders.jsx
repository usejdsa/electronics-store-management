...
function PurchaseOrders() {
  ...
  const handleSubmit = (e) => {
    ...
    // PUT /purchase-orders/:id for edit, POST for new
  ...
  const handleEdit = (o) => {
    setEditId(o.id);
    setForm({ supplier_id: o.supplier_id || '', product_id: o.product_id || '', sasia: o.sasia || '', cmimi_blerjes: o.cmimi_blerjes || '', shenime: o.shenime || '' });
  };
    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <select required value={form.supplier_id} onChange={set('supplier_id')}>
          ...
          {suppliers.map(s => <option key={s.id} value={s.id}>{s.emri_kompanise}</option>)}
        </select>
